    ...
    <table align="center" border="1" cellpadding="0" cellspacing="0">
    	...
    	<tr class="trOneLevel">
    		...
    		<td width="200px;">
    		  ...
    		  <a href="<c:url value='/adminCategoryServlet?method=updateParentPre&cid=${parent.cid}'/>">修改</a>
    	...
    	<tr class="trTwoLevel">
    		...
    		<td width="200px;" align="right">
    		  <a href="<c:url value='/adminCategoryServlet?method=updateChildPre&cid=${child.cid}'/>">修改</a>
